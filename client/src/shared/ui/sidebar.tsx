	...
	return (
		<SidebarContext.Provider value={contextValue}>
			<div
				...
				className={cn('group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-svh max-w-full', className)}
				{...props}
			>
				{children}
			</div>
...
function SidebarInset({ className, ...props }: React.ComponentProps<'main'>) {
	return (
		<main
			...
			className={cn(
				'relative flex justify-center w-full md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 overflow-x-hidden',
				className,
			)}
			{...props}
		/>
